...
static Class FLReflectionTypeProtocol;
static Class FLReflectionTypeBlock;

@implementation FLReflection

+ (void)initialize {
    FLReflectionTypeProtocol = object_getClass(@protocol(NSObject));
    FLReflectionTypeBlock = NSClassFromString(@"NSBlock");
}
...
+ (BOOL)isProtocol:(id)object {
    ...
    return [object_getClass(object) isEqual:FLReflectionTypeProtocol];
}
...
+ (BOOL)isBlock:(id)object {
    ...
    return [object isKindOfClass:FLReflectionTypeBlock];
}
